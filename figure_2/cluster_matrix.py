...
g = sns.clustermap(z, figsize=(size,size), col_colors=lut, row_colors=lut, col_cluster=True, xticklabels=False, yticklabels=False, cmap="YlGn_r")
...
plt.savefig("cluster_matrix.png", dpi=600)
#plt.show()
