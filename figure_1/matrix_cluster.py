...
g = sns.clustermap(z, figsize=(size,size), col_colors=lut, row_colors=lut, col_cluster=True, xticklabels=False, yticklabels=False, cmap="gray", metric="correlation")
...
g.cax.set_position([legend.x0+0.07+w_adjust, legend.y0*0.92+h_adjust, legend.width, legend.height*0.8])


plt.savefig("w-unifrac.png", dpi=600)
#plt.show()
