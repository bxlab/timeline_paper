...
x=float(sys.argv[2])
y=float(sys.argv[3])
g = sns.clustermap(df, figsize=(x,y), col_colors=lut, col_cluster=True, yticklabels=True, xticklabels=False, cmap="gray_r", vmin=0, vmax=1)
...
plt.savefig("pathway_clustermap.png", dpi=600)
#plt.show()
